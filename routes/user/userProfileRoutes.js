...
userProfileRouter.put('/profile/edit', isAuthenticated, userProfileController.updateProfile);
userProfileRouter.put('/profile/upload-image', isAuthenticated, userProfileController.uploadProfileImage);
...
userProfileRouter.put('/change-password', isAuthenticated, userProfileController.changePassword);
userProfileRouter.post('/request-password-change-otp', isAuthenticated, userProfileController.requestPasswordChangeOtp);
userProfileRouter.put('/verify-otp-and-change-password', isAuthenticated, userProfileController.verifyOtpAndChangePassword);
...
userProfileRouter.put('/profile/address/edit/:id', isAuthenticated, userProfileController.postEditAddress);
